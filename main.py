...
from core.handlers.basic import start_command, shuffle_command
...
async def create_pool():
    return await asyncpg.create_pool(user=settings.db.db_user, password=settings.db.db_pass, database=settings.db.db_name,
